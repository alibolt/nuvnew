        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium mb-2" style={{ color: textColor }}>
                  First Name
                </label>
                <input
                  id="firstName"
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-medium mb-2" style={{ color: textColor }}>
                  Last Name
                </label>
                <input
                  id="lastName"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium mb-2" style={{ color: textColor }}>
                Confirm Password
              </label>
              <input
                id="confirmPassword"
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="accept-terms" className="ml-2 block text-sm" style={{ color: textColor }}>
              I agree to the{' '}
              <Link href="/terms" className="underline hover:opacity-80" style={{ color: primaryColor }}>
                Terms and Conditions
              </Link>{' '}
              and{' '}
              <Link href="/privacy" className="underline hover:opacity-80" style={{ color: primaryColor }}>
                Privacy Policy
              </Link>
            </label>
          </div>
          ...
          <p className="mt-4 text-center text-sm" style={{ color: `${textColor}99` }}>
            ...
            <Link href="/login" className="font-medium hover:opacity-80" style={{ color: primaryColor }}>
              Sign in
            </Link>
          </p>
        </form>
