      ...
      case 'csv':
        ...
        return new NextResponse(csvHeader + csvRows, {
          headers: {
            ...
            'Content-Disposition': `attachment; filename="translations_${storeId}_${Date.now()}.csv"`
          }
        });
...
`;
        ...
        return new NextResponse(poContent, {
          headers: {
            ...
            'Content-Disposition': `attachment; filename="translations_${storeId}_${Date.now()}.po"`
          }
        });
      ...
      default:
        ...
        return new NextResponse(JSON.stringify(exportData, null, 2), {
          headers: {
            ...
            'Content-Disposition': `attachment; filename="translations_${storeId}_${Date.now()}.json"`
          }
        });
    }
  } catch (error) {
