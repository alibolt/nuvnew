...
// GET /api/stores/[subdomain]/products/[productId]/variants
export async function GET(
  ...
  try {
    ...
    return apiResponse.success({ variants: transformedVariants });
  } catch (error) {
...
// POST /api/stores/[subdomain]/products/[productId]/variants
