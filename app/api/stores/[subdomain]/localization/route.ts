...
export async function GET(
  ...
  try {
    ...
    const localizationSettings = (storeSettings as any)?.localizationSettings || {
      defaultLanguage: 'en',
      enabledLanguages: [
    ...
    localizationSettings.enabledLanguages.forEach((lang: any) => {
