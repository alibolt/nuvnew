...
export function TemplatesClient({ storeId }: TemplatesClientProps) {
  ...
  const loadTemplates = async () => {
    try {
      const response = await fetch(`/api/stores/${storeId}/templates`);
      if (response.ok) {
  ...
  const handleSetDefault = async (templateId: string) => {
    try {
      const response = await fetch(`/api/stores/${storeId}/templates/${templateId}`, {
        method: 'PUT',
    ...
    try {
      const response = await fetch(`/api/stores/${storeId}/templates`, {
        ...
        body: JSON.stringify({
          ...
          themeId: 'minimal', // You might want to get this from the template
  ...
  return (
    <div className="nuvi-tab-panel">
      <div className="nuvi-flex nuvi-items-center nuvi-justify-between nuvi-mb-lg">
        ...
        <Link href={`/dashboard/stores/${storeId}/theme-studio`}>
                ...
                {typeTemplates.map((template) => (
                  ...
                  >
                    ...
                    <div className="nuvi-flex nuvi-items-center nuvi-gap-sm">
                      ...
                      <Link
                        href={`/dashboard/stores/${storeId}/theme-studio?page=${type}&template=${template.id}`}
                      >
