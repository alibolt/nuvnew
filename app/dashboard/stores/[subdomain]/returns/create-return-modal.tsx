...
export function CreateReturnModal({ subdomain, recentOrders, onClose, onCreate }: CreateReturnModalProps) {
            ...
            <div>
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-1.5 border border-[var(--nuvi-border)] rounded text-xs font-medium bg-[var(--nuvi-surface)] text-[var(--nuvi-text-primary)] focus:border-[var(--nuvi-primary)] focus:ring-1 focus:ring-[var(--nuvi-primary)] w-full"
                />
              </div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <select
                                ...
                                className="mt-1 block w-full px-3 py-1.5 border border-[var(--nuvi-border)] rounded text-xs font-medium bg-[var(--nuvi-surface)] text-[var(--nuvi-text-primary)] focus:border-[var(--nuvi-primary)] focus:ring-1 focus:ring-[var(--nuvi-primary)]"
                              >
                                {reasons.map((reason) => (
