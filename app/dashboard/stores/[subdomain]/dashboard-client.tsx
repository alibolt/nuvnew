...
import { SettingsModal, useSettingsModal } from '@/components/dashboard/settings-modal';
...
export function DashboardClient({ store, allStores, session }: DashboardClientProps) {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'products' | 'orders' | 'customers' | 'marketing' | 'content' | 'analytics' | 'translations' | 'apps' | 'ai' | 'settings'>(tabParam || 'overview');
  ...
  return (
    <div className="nuvi-dashboard">
      <div className="nuvi-tabs">
        <div className="nuvi-tabs-list">
          ...
          <div className="nuvi-tabs-center">
            ...
            <button
              onClick={() => router.push(`/dashboard/stores/${store.subdomain}/translations`)}
              className={`nuvi-tab ${activeTab === 'translations' ? 'active' : ''}`}
            >
              <Languages className="h-4 w-4" />
              <span className="nuvi-tab-label">Translations</span>
            </button>
            <button
              onClick={() => router.push(`/dashboard/stores/${store.subdomain}/themes`)}
              className={`nuvi-tab`}
            >
            ...
            <button
              onClick={() => openSettings(`/dashboard/stores/${store.subdomain}/settings`)}
              className="nuvi-tab"
            >
      ...
      <div className="nuvi-tab-content">
                ...
                <div className="nuvi-card-content">
                  <div className="nuvi-h-64 nuvi-flex nuvi-items-center nuvi-justify-center nuvi-bg-surface-hover nuvi-rounded-lg">
                    <div className="nuvi-text-center">
                      ...
                      <p className="nuvi-text-muted">No data available</p>
              ...
              <div className="nuvi-sub-tab-content">
                ...
                <div className="nuvi-grid nuvi-grid-cols-1 nuvi-md:grid-cols-2 nuvi-lg:grid-cols-3 nuvi-gap-md">
                  ...
                  <div className="nuvi-card">
                    <div className="nuvi-card-content">
                      <div className="nuvi-flex nuvi-items-start nuvi-gap-md">
                        <div className="nuvi-w-12 nuvi-h-12 nuvi-bg-[#8B9F7E]/10 nuvi-rounded-lg nuvi-flex nuvi-items-center nuvi-justify-center">
                          <Mail className="h-6 w-6 nuvi-text-[#8B9F7E]" />
                        </div>
                        <div className="nuvi-flex-1">
        ...
        {activeTab === 'analytics' && (
          <AnalyticsContent subdomain={store.subdomain} />
        )}
